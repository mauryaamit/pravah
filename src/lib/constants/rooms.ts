...
export const ROOMS: Room[] = [
  ...
  { id: 'neurolab',    name: 'NeuroLab',     nameHi: 'न्यूरोलैब', nameHindi: 'न्यूरोलैब', emoji: '🧠', description: 'Daily brain science and mind psychology',           route: '/neurolab',     colorVar: '--room-neurolab',     colorHex: '#7A3A8A', cluster: 'knowledge' },
  ...
  // WORLD
  { id: 'khabar',      name: 'Khabar',       nameHi: 'खबर',        nameHindi: 'खबर',       emoji: '📰', description: 'Daily Intelligence & Current Affairs — India and the World', route: '/khabar', colorVar: '--room-khabar', colorHex: '#1E3A5F', cluster: 'world' },
